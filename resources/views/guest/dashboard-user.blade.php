...
<body>
    ...
    <section class="deskripsi">
        <div class="sub-deskripsi">
            <img src="{{ asset('img/money-icon.png') }}" alt="Kos 1" width="100" height="100" class="logo-subdivisi">
        ...
        <div class="sub-deskripsi">
            <img src="{{ asset('img/ChatGPT Image 1 Mei 2025, 16.15.09.png') }}" alt="Kos 1" width="100" height="100" class="logo-subdivisi">
            <h3>Lokasi Strategis</h3>
            <p>Anda dapat memilih kos yang berlokasi strategis, dekat dengan kampus, pusat perbelanjaan, dan transportasi umum.</p>
        </div>
        <div class="sub-deskripsi">
            <img src="{{ asset('img/koskamling-logo.png') }}" alt="Kos 1" width="115" height="100" class="logo-subdivisi">
    ...
    <div class="daftar-kota">
        ...
        <div class="kota-button">
          ...
          <label for="yogyakarta" class="kota-card" style="background-image: url('{{ asset('img/yogyakarta.jpg') }}');">
            <a href="" class="nama-kota">Kos di Yogyakarta</a>
          </label>
          <label for="purwokerto" class="kota-card" style="background-image: url('{{ asset('img/purwokerto.jpg') }}');">
